...
plot(sensi_sLOO[2:26],type='b',col='blue',xlab="number of voice samples",ylab="Sensitivity",ylim=c(0.4,1))
...
plot(speci_sLOO[2:26],type='b',col='blue',xlab="number of voice samples",ylab="Specitivity",ylim=c(0.4,1))
